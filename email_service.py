...
{message}
    ...
    def send_donation_thank_you(self, email: str, name: str, amount: float, project_title: str) -> bool:
        """
        ...
        Thank you so much for your generous donation of ${amount:.2f} to {project_title}!
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <p>Thank you so much for your generous donation of <strong>${amount:.2f}</strong> to <strong>{project_title}</strong>!</p>
                    ...
                    <div style="background: #d4edda; border: 1px solid #c3e6cb; padding: 20px; border-radius: 8px; margin: 20px 0; text-align: center;">
                        ...
                        <div style="font-size: 2em; color: #28a745; font-weight: bold; margin: 10px 0;">${amount:.2f}</div>
                        <p style="margin: 0; color: #155724;">for {project_title}</p>
                    </div>
    ...
    def send_newsletter_welcome(self, email: str, name: str) -> bool:
        """
        Send a welcome email for newsletter subscription
        """
        subject = "Welcome to Lusan's Newsletter! 🚀"
        
        text_body = f"""
        Hello {name},

        Welcome to my newsletter! Thank you for subscribing and showing interest in my work.

        You'll receive updates about:
        ✨ New projects and open source releases
        🔧 Development tips and tutorials
        💡 Tech insights and industry trends
        🎯 Behind-the-scenes development stories
        🚀 Exciting opportunities and collaborations

        I promise to only send valuable content and respect your inbox. You can update your preferences or unsubscribe at any time.
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                <header style="text-align: center; margin-bottom: 30px;">
                    <h1 style="color: #2c3e50; margin-bottom: 10px;">Welcome to the Newsletter! 🚀</h1>
                    <div style="height: 3px; background: linear-gradient(135deg, #f39c12, #e67e22); border-radius: 2px;"></div>
                </header>
                ...
                <div style="margin-bottom: 30px;">
                    ...
                    <p>Welcome to my newsletter! Thank you for subscribing and showing interest in my work.</p>
                    
                    <div style="background: #e3f2fd; border: 1px solid #bbdefb; padding: 20px; border-radius: 8px; margin: 20px 0;">
                        <h3 style="color: #1565c0; margin: 0 0 15px 0;">You'll receive updates about:</h3>
                        <ul style="color: #1565c0; margin: 0; padding-left: 20px; list-style: none;">
                            <li style="margin-bottom: 8px;">✨ New projects and open source releases</li>
                            <li style="margin-bottom: 8px;">🔧 Development tips and tutorials</li>
                            <li style="margin-bottom: 8px;">💡 Tech insights and industry trends</li>
                            <li style="margin-bottom: 8px;">🎯 Behind-the-scenes development stories</li>
                            <li style="margin-bottom: 8px;">🚀 Exciting opportunities and collaborations</li>
                        </ul>
                    </div>
                    
                    <p>I promise to only send valuable content and respect your inbox. You can update your preferences or unsubscribe at any time.</p>
                    
                    <div style="text-align: center; margin: 30px 0;">
                        <p style="font-size: 1.2em; color: #f39c12; font-weight: 500;">Stay tuned for amazing content coming your way!</p>
                    </div>
                </div>
                
                <footer style="border-top: 1px solid #eee; padding-top: 20px; text-align: center;">
                    <div style="margin-bottom: 15px;">
                        <h3 style="color: #2c3e50; margin-bottom: 5px;">Best regards,</h3>
                        <h3 style="color: #2c3e50; margin-bottom: 5px;">Lusan Sapkota</h3>
                        <p style="color: #f39c12; margin: 0; font-weight: 500;">Full Stack Developer</p>
                    </div>
                    ...
                    <div style="color: #666; font-size: 0.9em;">
                        <p style="margin: 0;">Thank you for joining the community!</p>
                    </div>
                </footer>
            </div>
        </body>
    ...
    def send_admin_login_notification(self, username: str, ip_address: str, timestamp: datetime) -> bool:
        """
...
Admin Panel: https://lusansapkota.com.np/admin
            ...
            <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f8f9fa;">
                <div style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <!-- Header -->
                    <header style="background: linear-gradient(135deg, #dc3545, #c82333); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
                    ...
                    <div style="padding: 30px;">
                        ...
                        <div style="background-color: #f8f9fa; border-radius: 8px; padding: 20px; margin-bottom: 25px;">
                            ...
                            <table style="width: 100%; border-collapse: collapse;">
                                <tr>
                                    <td style="padding: 8px 0; color: #6c757d; font-weight: 500; width: 30%;">👤 Username:</td>
                                ...
                                <tr>
                                    <td style="padding: 8px 0; color: #6c757d; font-weight: 500;">🌐 IP Address:</td>
                                    <td style="padding: 8px 0; color: #343a40; font-weight: 600;">{ip_info['ip']}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0; color: #6c757d; font-weight: 500;">📍 Location:</td>
                                    <td style="padding: 8px 0; color: #343a40; font-weight: 600;">{ip_info['city']}, {ip_info['region']}, {ip_info['country']}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0; color: #6c757d; font-weight: 500;">🏢 ISP:</td>
                                    <td style="padding: 8px 0; color: #343a40; font-weight: 600;">{ip_info['isp']}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0; color: #6c757d; font-weight: 500;">🏢 Organization:</td>
                                    <td style="padding: 8px 0; color: #343a40; font-weight: 600;">{ip_info['org']}</td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0; color: #6c757d; font-weight: 500;">🕐 Timezone:</td>
...
Admin Panel: https://lusansapkota.com.np/admin
    ...
    def send_admin_password_change_notification(self, username: str, ip_address: str, timestamp: datetime) -> bool:
        """
        Send admin password change notification email with security details
        """
        try:
            # Get IP geolocation info
            ip_info = get_ip_info(ip_address)
            ...
            # Prepare email content
            subject = f"🔒 Admin Password Changed - {username}"
...
1. Log into your admin panel immediately
                ...
                <div style="max-width: 600px; margin: 0 auto; background-color: white; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <div style="padding: 30px;">
                        ...
                        <div style="background-color: #fff3cd; border: 1px solid #ffeaa7; border-radius: 8px; padding: 20px; margin-bottom: 25px;">
                            ...
                            <p style="color: #856404; margin: 0; font-size: 14px; line-height: 1.5;">
                                If you did not make this password change, please:
                            </p>
                            <ul style="color: #856404; font-size: 14px; margin: 10px 0 0 20px; padding: 0;">
                                <li>Log into your admin panel immediately</li>
                                <li>Change your password again to a secure one</li>
                                <li>Review admin activity logs for suspicious activity</li>
